...
@section('content')
    <div x-data="{ modal: false }">
        <div href="/admin/courses" class="inline-block px-6 py-2 bg-green-500 text-white rounded-sm hover:bg-green-400 cursor-pointer my-4" @click="modal = true">New Course</div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {{-- <a href="/admin/courses/delete/{{$item->id}}" class="my-1 inline-block px-6 py-2 bg-red-600 text-white rounded-md">Delete</a> --}}
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
    ...
    <div class="fixed z-50 top-10 left-1/4 w-1/2 p-12 bg-white shadow-lg" x-show.transition="modal">
        ...
        <form action="/admin/course/create" method="POST">
            ...
            <div class="my-4">
                <button class="px-6 py-2 bg-green-500 text-white rounded-sm float-right w-full block">Add Course</button>
            </div>
        </form>
    </div>
    </div>
